      ...
      <div className="container mdq">
        ...
        <div className="mdq info">
          <div className="mdq">
            ...
            <h5 className="dec">
              <i class="fas fa-code webIcon dec" /> Web Developer | DevOps
            </h5>
          </div>

          <div className="Btn-Div">
            <a href="https://drive.google.com/file/d/19YxE8Xr2ZNDt09KI_G3jDuntZQfxAM5H/view?usp=sharing"  className="ResumeText">
          ...
          <div className="split socialIcons">
            ...
            <div className="Icon">
              <a href="https://www.instagram.com/siddharthh_57/" target="_blank">
